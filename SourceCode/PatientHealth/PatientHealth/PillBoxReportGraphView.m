...
@interface PillBoxReportGraphView ()
{
    NSArray *date;
    NSArray *percentage;
}
...
@implementation PillBoxReportGraphView
...
-(void)constructScatterPlot
{
    ...
    NSArray *dates = [NSArray arrayWithObjects:@"", @"Sunday", @"Monday", @"Tuesday", @"Wednesday", @"Thrusday",@"Friday" ,@"Saturday",nil];
    ...
    xGridLineStyle.lineColor = [[CPTColor redColor]colorWithAlphaComponent:1.0] ;
    ...
    yGridLineStyle.lineColor = [[CPTColor redColor]colorWithAlphaComponent:1.0] ;
...
//    lineStyle.dashPattern            = @[@2.5f, @0.1f];
    ...
    secondarySourceLinePlot.identifier = @"Red Plot";
...
//    newLineStyle.dashPattern            = @[@2.0f, @0.1f];
    secondarySourceLinePlot.dataLineStyle = nil;
...
- (CPTPlotSymbol *)symbolForScatterPlot:(CPTScatterPlot *)aPlot recordIndex:(NSUInteger)index
{
    ...
    else if ([[aPlot identifier] isEqual:@"Red Plot"])
    {
        [plotSymbol setFill:[CPTFill fillWithColor:[CPTColor redColor]]];
    }
    else {
